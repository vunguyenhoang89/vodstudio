...
class contacts_shortcode {
	...
	public function register_shortcode($shortcodeName) {
		function shortcode_contacts($atts, $content = null) {
            ...
            if (is_array($pagebuilder['modules'][$module_id]['contact_info_icons'])) {
                $compile .= "<ul class='contact_info_list'>";
                foreach ($pagebuilder['modules'][$module_id]['contact_info_icons'] as $key => $value) {
                    if ($value['link'] != '') {
                    ...
                    $compile .= "<li class='contact_info_item'><div class='contact_info_wrapper'><span class='contact_info_icon' style='background:#".$value['bcolor'].";'><i style='color:#".$value['fcolor']."' class='".$value['data-icon-code']."'></i></span>".$contact_content."</div></li>";
                }
                $compile .= "</ul>";
            }
			return $compile;
