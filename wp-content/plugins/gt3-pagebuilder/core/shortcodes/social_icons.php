...
class social_icons_shortcode {
	...
	public function register_shortcode($shortcodeName) {
		function shortcode_social_icon($atts, $content = null) {
			...
			if ($href == '') {
				return '<span class="shortcode_social_icon '.$style.'" style="background:'.$bg_color.'"><span><i class="'.$icon.'" style="color:'.$color.'"></i></span></span>';
			} else {
				return '<a href="'.$href.'" class="shortcode_social_icon '.$style.'" style="background:'.$bg_color.'"><span><i class="'.$icon.'" style="color:'.$color.'"></i></span></a>';
			}
		}
...
<script>
	function ".$shortcodeName."_handler() {
		...
		var compileline = '[".$shortcodeName." bg_color=\"#'+bg_color+'\" color=\"#'+color+'\" icon=\"'+icon+'\" href=\"'+href+'\"][/".$shortcodeName."]';
