				...
				<div class="promoblock_wrapper">
					<div class="promo_text_block">
						<div class="promo_text_block_wrapper">
							' . (isset($main_text) ? "<h4 ".(strlen($main_text_color)>0 ? "style='color:#".$main_text_color." !important;'" : "").">" . $main_text . "</h4>" : '') . '
							' . (isset($additional_text) ? "<h6 ".(strlen($additional_text_color)>0 ? "style='color:#".$additional_text_color." !important;'" : "").">" . $additional_text . "</h6>" : '') . '
						</div>
					</div>
						' . ((strlen($button_link) > 0 && strlen($button_text) > 0) ? '<div class="promo_button_block"><a href="'.$button_link.'" class="'.$button_type.'">'.$button_text.'</a></div>' : '') . '
				</div>
			</div>
            ';
