...
<div class='pop_scrollable_area'>
    ...
    <div class='padding-cont'>
        " . get_module_settings_part_upload_file($pagebuilder, $moduleid, $pb_module_size_now, $GLOBALS["pbconfig"], __("Before image", "gt3_builder"), "image_before", "90%") . "
        " . get_module_settings_part_upload_file($pagebuilder, $moduleid, $pb_module_size_now, $GLOBALS["pbconfig"], __("After image", "gt3_builder"), "image_after", "90%") . "
...
<div class='pop_scrollable_area'>
    ...
    <div class='padding-cont'>
        ...
        " . get_module_settings_part_input($pagebuilder, $moduleid, $pb_module_size_now, $GLOBALS["pbconfig"], __("Counter count", "gt3_builder"), "stat_count", "100%", "left") . "	
		" . get_module_settings_part_input($pagebuilder, $moduleid, $pb_module_size_now, $GLOBALS["pbconfig"], __("Counter title", "gt3_builder"), "stat_title", "100%", "left") . "
        " . get_module_settings_part_padding_bottom($pagebuilder, $moduleid) . "
        <div class='clear'></div>
    </div>
    " . get_module_settings_part_done_btn() . "
