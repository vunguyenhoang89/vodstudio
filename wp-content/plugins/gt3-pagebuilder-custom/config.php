...
$GLOBALS["pbconfig"]['default_heading_in_module'] = "h5";

#available quote types
$GLOBALS["pbconfig"]['all_available_quote_types'] = array("" => "Default", "type1" => "Type1", "type2" => "Type2");
...
$GLOBALS["pbconfig"]['default_padding_after_module'] = "50px";
