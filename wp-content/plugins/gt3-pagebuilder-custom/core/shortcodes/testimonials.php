                                ...
                                <div class='item'>
									<div class='testimonial_item_wrapper'>
										<div class='testimonials_photo'>
												".(strlen($featured_image[0])>0 ? "<img alt='". $featured_alt ."' src='".aq_resize($featured_image[0], "128", "128", true, true, true)."' class='testimonials_ava'>" : "")."
										</div>
										<div class='testimonials_text'>" . $post->post_content . "</div>
									</div>
									<div class='testimonials_footer'>
										{$testimonials_author}, {$testimonials_company}
									</div>									
								</div>
                            </li>
                        ";
