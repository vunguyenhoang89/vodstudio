				...
				<div class="promoblock_wrapper">
					<div class="promo_text_block">
						<div class="promo_text_block_wrapper">
							' . (isset($main_text) ? "<h3 ".(strlen($main_text_color)>0 ? "style='color:#".$main_text_color." !important;'" : "")." class='promo_title'>" . $main_text . "</h3>" : '') . '
						...
						' . ((strlen($button_link) > 0 && strlen($button_text) > 0) ? '<div class="promo_button_block"><a href="'.$button_link.'" target="'. $button_target .'" class="promo_button shortcode_button '.$button_type.'">'.$button_text.'</a></div>' : '') . '
				</div>
			</div>
            ';
