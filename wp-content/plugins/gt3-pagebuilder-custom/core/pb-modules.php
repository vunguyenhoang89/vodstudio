            ...
            foreach ($gt3_theme_pagebuilder['modules'][$moduleid]['module_items'] as $itemid => $item) {
                ...
                <li class='section'>
                    <div class='heading line_option visual_style1 big_type'>
                        <div class='option_title text-shadow1'>". esc_attr($item['title']) ."</div>
                    ...
                    <div class='hide_area'>
                        <div class='some-padding'>
                            <input type='text' class='expanded_text1 type1 section_name' name='pagebuilder[modules][$moduleid][module_items][{$itemid}][title]' value='". esc_attr($item['title']) ."'>
                            <textarea class='expanded_text1 type2 mt tinytextarea' id='".$tinymce_activation_class."' name='pagebuilder[modules][$moduleid][module_items][{$itemid}][description]'>". esc_attr($item['description']) ."</textarea>
                        </div>
            ...
            foreach ($gt3_theme_pagebuilder['modules'][$moduleid]['module_items'] as $itemid => $item) {
                ...
                <li class='section'>
                    ...
                    <div class='hide_area'>
                        <div class='some-padding'>
                            <input type='text' class='expanded_text1 type1 section_name' name='pagebuilder[modules][$moduleid][module_items][{$itemid}][title]' value='". esc_attr($item['title']) ."'>
                            <textarea class='expanded_text1 type2 mt tinytextarea' name='pagebuilder[modules][$moduleid][module_items][{$itemid}][description]'>". esc_attr($item['description']) ."</textarea>
                        </div>
                        <div class='expanded_state_cont'>
                            <span class='text-shadow1'>" . __('Expanded', 'gt3_builder') . "</span>
...
<div class='pop_scrollable_area'>
    ...
    <div class='padding-cont diagram_admin'>
		<div class='gt3_floated_option diagram_bg_wrapper'><h5>" . __('Bar Background', 'gt3_builder') . ":</h5>" . colorpicker_block("pagebuilder[modules][$moduleid][diagram_bg]", (isset($gt3_theme_pagebuilder['modules'][$moduleid]['diagram_bg']) ? $gt3_theme_pagebuilder['modules'][$moduleid]['diagram_bg'] : 'e4e7e9')) . "</div>
		<div class='gt3_floated_option diagram_bg_wrapper'><h5>" . __('Bar Color', 'gt3_builder') . ":</h5>" . colorpicker_block("pagebuilder[modules][$moduleid][diagram_color]", (isset($gt3_theme_pagebuilder['modules'][$moduleid]['diagram_color']) ? $gt3_theme_pagebuilder['modules'][$moduleid]['diagram_color'] : 'ef969a')) . "</div>
		...
		<div class='gt3_floated_option'>" . get_module_settings_part_input($gt3_theme_pagebuilder, $moduleid, $pb_module_size_now, $GLOBALS["pbconfig"], __('Bar Size:', 'gt3_builder'), "diagram_size", "95px", "left", "60px") . "</div>
		<div class='gt3_floated_option'>" . get_module_settings_part_input($gt3_theme_pagebuilder, $moduleid, $pb_module_size_now, $GLOBALS["pbconfig"], __('Font Size:', 'gt3_builder'), "percent_size", "95px", "left", "14px") . "</div>
		<div class='clear'></div>
