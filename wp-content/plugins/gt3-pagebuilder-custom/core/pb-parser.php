        ...
        if ($module['name']=="bg_start" || $module['name']=="bg_end") {
            ...
            switch ($module['name']) {
                ...
                case "promo_text":
                    ...
                    heading_size='".$module["heading_size"]."'
                    heading_text=\"".$module["heading_text"]."\"
                    main_text='".htmlspecialchars($module["main_text"],ENT_QUOTES)."' 
                    main_text_color='".$module["main_text_color"]."' 
                    additional_text_color='".$module["additional_text_color"]."'
                    button_text='".htmlspecialchars($module["button_text"],ENT_QUOTES)."' 
                    button_link='".$module["button_link"]."'
					button_target='".$module["button_target"]."'
					button_type='".$module["promo_button_type"]."'
                    additional_text='".htmlspecialchars($module["additional_text"],ENT_QUOTES)."'][/promo_text]");
                    break;
                #BREAK
                ...
                case "counter":
                    ...
                    heading_size='".$module["heading_size"]."'
                    heading_text=\"".$module["heading_text"]."\"
					stat_title=\"".htmlspecialchars($module["stat_title"],ENT_QUOTES)."\" 
					stat_text=\"".htmlspecialchars($module["stat_text"],ENT_QUOTES)."\" 
                ...
                case "accordion":
                    ...
                    if (is_array($module["module_items"])) {
                        foreach ($module["module_items"] as $acckey => $acc_item) {
                            $accompile .= "[accordion_item title='". esc_attr($acc_item['title'])."' expanded_state='".$acc_item['expanded_state']."']".$acc_item['description']."[/accordion_item]";
                        }
                    }
                ...
                case "price_table":
                    ...
                    if (isset($module["module_items"]) && is_array($module["module_items"])) {
                        ...
                        foreach ($module["module_items"] as $key => $thisitem) {
							...
							$tempcompile .= "[pricetable_item block_name='".esc_attr($thisitem['block_name'])."' block_price='".esc_attr($thisitem['block_price'])."' block_period='".esc_attr($thisitem['block_period'])."' price_features='". esc_attr($price_features)."' block_link='".$thisitem['block_link']."' get_it_now_caption='".esc_attr($thisitem['get_it_now_caption'])."' most_popular='".$thisitem['most_popular']."' width='".$thiswidth."'][/pricetable_item]";
                        }
                    }
                ...
                case "toggle":
                    ...
                    if (is_array($module["module_items"])) {
                        foreach ($module["module_items"] as $togglekey => $togg_item) {
                            $toggompile .= "[toggles_item title='". esc_attr($togg_item['title'])."' expanded_state='".$togg_item['expanded_state']."']".$togg_item['description']."[/toggles_item]";
                        }
                    }
